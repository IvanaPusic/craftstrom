...
/* harmony import */ var _features_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./features.js */ "./src/js/features.js");
...
function _loadTemplate() {
  _loadTemplate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(part, elementId) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return fetch("./src/template-parts/".concat(part, ".html"));
        case 3:
        ...
        case 11:
          ...
          console.error("Error loading ".concat(part, ":"), _context2.t0);
        case 14:
        case "end":
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        _context.next = 3;
        return loadTemplate('hero', 'hero');
      case 3:
        _context.next = 5;
        return loadTemplate('video', 'video');
      case 5:
        _context.next = 7;
        return loadTemplate('products', 'products');
      case 7:
        _context.next = 9;
        return loadTemplate('features', 'features');
      case 9:
        _context.next = 11;
        return loadTemplate('types-of-solar-system', 'types-of-solar-system');
      case 11:
        _context.next = 13;
        return loadTemplate('popular-kits', 'popular-kits');
      case 13:
        _context.next = 15;
        return loadTemplate('benefits', 'benefits');
      case 15:
        _context.next = 17;
        return loadTemplate('configure-solar-and-battery', 'configure-solar-and-battery');
      case 17:
        _context.next = 19;
        return loadTemplate('learn-more', 'learn-more');
      case 19:
        _context.next = 21;
        return loadTemplate('blog', 'blog');
      case 21:
        ...
        if (swiper.activeIndex === 0 || mobileSwiper.activeIndex === 0) {
          (0,_features_js__WEBPACK_IMPORTED_MODULE_0__.addColor)(titles[0], texts[0]);
          (0,_features_js__WEBPACK_IMPORTED_MODULE_0__.addColor)(mobileTitles[0], mobileTexts[0]);
        }
...
function handleSlideChange(swiperInstance, titlesArray, textsArray, imagesArray) {
  ...
  _features_js__WEBPACK_IMPORTED_MODULE_0__.removeColor.apply(void 0, _toConsumableArray(titlesArray));
  _features_js__WEBPACK_IMPORTED_MODULE_0__.removeColor.apply(void 0, _toConsumableArray(textsArray));
  (0,_features_js__WEBPACK_IMPORTED_MODULE_0__.addColor)(titlesArray[activeIndex], textsArray[activeIndex]);
}
...
/* harmony export */   removeColor: () => (/* binding */ removeColor)
/* harmony export */ });
var addColor = function addColor(titles, texts) {
  titles.style.color = '#F9A41A';
  titles.style.opacity = 1;
  texts.style.color = '#fff';
  texts.style.opacity = 1;
};
var removeColor = function removeColor(titles1, titles2, titles3, texts1, texts2, texts3) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcraftstrom"] = self["webpackChunkcraftstrom"] || [];
